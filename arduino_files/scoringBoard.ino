...
void loop(void)
{
   ...
   dmd.drawString(  5,  0, "1", 1, GRAPHICS_NORMAL );
   dmd.drawString(  22,  0, "01", 1, GRAPHICS_NORMAL );
//   dmd.selectFont(Droid_Sans_12);
   int scoreX=3;
   int scoreXm=18;
   int scoreY=9;
   dmd.drawString(  scoreX,  scoreY, "12", 2, GRAPHICS_NORMAL );
   dmd.drawString(  scoreXm, scoreY, "34", 2, GRAPHICS_NORMAL );
   delay( 8000 );  
   dmd.drawString(  scoreX,  scoreY, "56", 2, GRAPHICS_NORMAL );
   dmd.drawString(  scoreXm, scoreY, "78", 2, GRAPHICS_NORMAL );  
   delay( 8000 );  
   dmd.drawString(  scoreX,  scoreY, "90", 2, GRAPHICS_NORMAL );
   dmd.drawString(  scoreXm, scoreY, "10", 2, GRAPHICS_NORMAL ); 
   delay( 8000 );    
